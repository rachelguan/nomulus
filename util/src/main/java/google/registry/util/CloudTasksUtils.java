...
public class CloudTasksUtils implements Serializable {
  ...
  public abstract static class TaskInfo {
    ...
    public static CloudTasksUtils.TaskInfo create(
        String queueName, HttpMethod method, String path, String service, ImmutableMultimap<String, String> param,
        Optional<Integer> jitterSeconds) {
      return new AutoValue_CloudTasksUtils_TaskInfo(queueName, method, path, service, param, jitterSeconds);
    }
